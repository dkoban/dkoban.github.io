...
cat_tbl <- data_frame(
  ...
  "Random" = c(nrow(random),
               ...
               paste0("<b>", format_counts(random_bot_prop$fake, nrow(random)),
                      "</b>"),
               paste0("<b>", format_counts(random_bot_prop$spammer, nrow(random)),
                      "</b>"),
...
- I forgot to filter on english only tweets when rehydrating the coronavirus tweets and pulling the random sample.  Do I need to repull my data???
