...
1. Randomly sample 17,000 users from GWU's [Tweet Sets Library]( https://tweetsets.library.gwu.edu/datasets) in teh following collections:
...
```{r}
df<- read.table(file = "~/Documents/EM6574/COVID_version7/coronavirus-through-09-June-2020-23.txt",  sep="\t")
```
